...
var Helpers = handlers.ExecFuncs{
	...
	"files-find-sbin":         filesFindSbinCmd,
	"files-find-icons":        filesFindIconsCmd,
	"files-find-desktop":      filesFindDesktopCmd,
	"files-find-dbus":         filesFindDbusCmd,
	"files-find-polkit":       filesFindPolkitCmd,
	// Short aliases
	"ff":              filesFindCmd,
	"ff-lang":         filesFindLangCmd,
	"ff-doc":          filesFindDocCmd,
	"ff-bin":          filesFindBinCmd,
	"ff-lib":          filesFindLibCmd,
	"ff-include":      filesFindIncludeCmd,
	"ff-share":        filesFindShareCmd,
	"ff-man":          filesFindManCmd,
	"ff-config":       filesFindConfigCmd,
	"ff-systemd":      filesFindSystemdCmd,
	"ff-systemd-user": filesFindSystemdUserCmd,
	"ff-license":      filesFindLicenseCmd,
	"ff-sbin":         filesFindSbinCmd,
	"ff-icons":        filesFindIconsCmd,
	"ff-desktop":      filesFindDesktopCmd,
	"ff-dbus":         filesFindDbusCmd,
	"ff-polkit":       filesFindPolkitCmd,
}
